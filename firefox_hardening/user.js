...
/*** [SECTION 0400]: SAFE BROWSING (SB)
 S B has taken many steps to preserve privacy. If required, a full url is never s*ent
...
/*** [SECTION 0900]: PASSWORDS
 [ 1] https://support.mozilla.org/kb/use-primary-password-protect-stored-logins-a*nd-pas
 ***/
...
/*** [SECTION 1200]: HTTPS (SSL/TLS / OCSP / CERTS / HPKP)
 Y our cipher and other settings can be used in server side fingerprinting       *
...
/*** [SECTION 1600]: REFERERS
 f ull URI: https://example.com:8888/foo/bar.html?id=1234         *
...
/*** [SECTION 2800]: SHUTDOWN & SANITIZING
 W e enable sanitizeOnShutdown to help prevent 1st party website tracking across *sessions.
...
/*** [SECTION 5000]: OPTIONAL OPSEC
 D isk avoidance, application data isolation, eyeballs...                        *
 ***/
...
/*** [SECTION 5500]: OPTIONAL HARDENING
 N ot recommended. Overriding these can cause breakage and performance issues,   *
...
/*** [SECTION 8000]: DON'T BOTHER: FINGERPRINTING
 [ WHY] They are insufficient to help anti-fingerprinting and do more harm than g*ood
...
/*** [SECTION 8500]: TELEMETRY
 A rkenfox does not consider Firefox telemetry to be a privacy or security concer*n - comments below.
